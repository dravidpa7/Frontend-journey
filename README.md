...
| Day 9  | Desktop version completed [Task-5], responsive (mobile 375px) completed <br> [Task-6] Social profile card responsive (mobile 375px) completed, [Task-7] Started | [Cooking Recipe](https://dravid-cooking-recipe.netlify.app/)<br>[Social Profile Card](https://dravid-social-profile-card.netlify.app/) |
| Day 10 | [Task-7] Completed with responsive, [Task-8] Started | [Product Card](https://dravid-product-card.netlify.app/) |
